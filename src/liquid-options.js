...
module.exports = function(eleventyConfig) {
  eleventyConfig.on("eleventy.after", function() {
    if("strict_filters" in eleventyConfig.liquidOptions) {
      console.warn(chalk.blue("[11ty/eleventy-upgrade-help] ") + "The liquidjs package renamed the `strict_filters` option to `strictFilters`. Please rename it in `eleventyConfig.setLiquidOptions` accordingly.");
